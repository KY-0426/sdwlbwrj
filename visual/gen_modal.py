...
def merge_joint_bone_data(set):
    ...
    data_jpt_bone = open_memmap('../data/{}_joint_bone.npy'.format(set), dtype='float32', mode='w+',
                                shape=(N, 6, T, V, M))
...
if __name__ == '__main__':
    ...
    if os.path.exists('data/test_A_joint.npy'):
        os.rename('data/test_A_joint.npy', 'data/test_B_joint.npy')
